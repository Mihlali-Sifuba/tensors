...
structural = VariableNode()
assert_type(structural + variable, VariableNode)
assert_type(variable + structural, VariableNode)
assert_type(structural * structural, VariableNode)
assert_type(structural @ variable, VariableNode)
assert_type(-structural, VariableNode)
assert_type(structural[0], VariableNode)
assert_type(ts.relu(structural), VariableNode)
assert_type(ts.sigmoid(structural), VariableNode)
assert_type(ts.matmul(structural, variable), VariableNode)
assert_type(ts.matmul(variable, structural), VariableNode)
assert_type(ts.relu(variable), ts.Variable)
assert_type(ts.relu(tensor), ts.Tensor)
assert_type(ts.sigmoid(variable), ts.Variable)
assert_type(ts.sigmoid(tensor), ts.Tensor)
assert_type(ts.outer(structural, variable), VariableNode)
assert_type(ts.outer(variable, structural), VariableNode)
assert_type(ts.outer(variable, tensor), ts.Variable)
assert_type(ts.norm(structural), VariableNode)
assert_type(ts.norm(variable), ts.Variable)
assert_type(ts.norm(tensor), ts.Tensor)
assert_type(ts.exp(structural), VariableNode)
assert_type(ts.exp(variable), ts.Variable)
assert_type(ts.exp(tensor), ts.Tensor)
assert_type(ts.tanh(structural), VariableNode)
assert_type(ts.sqrt(structural), VariableNode)
assert_type(ts.abs(structural), VariableNode)
assert_type(ts.log(variable), ts.Variable)
assert_type(ts.arccosh(tensor), ts.Tensor)
assert_type(ts.matmul(variable, tensor), ts.Variable)
...
assert_type(ts.sum(structural), VariableNode)
assert_type(ts.mean(structural), VariableNode)
assert_type(ts.mean(variable, axis=0, keepdims=True), ts.Variable)
assert_type(ts.prod(structural), VariableNode)
assert_type(ts.max(structural), VariableNode)
assert_type(ts.min(structural), VariableNode)
assert_type(ts.std(structural), VariableNode)
assert_type(ts.variance(structural), VariableNode)
assert_type(ts.logsumexp(structural), VariableNode)
assert_type(ts.softmax(structural), VariableNode)
assert_type(ts.log_softmax(structural), VariableNode)
assert_type(ts.log_softmax(tensor), ts.Tensor)
assert_type(ts.reshape(variable, (2, 1)), ts.Variable)
assert_type(ts.reshape(structural, (2, 1)), VariableNode)
assert_type(ts.transpose(structural), VariableNode)
assert_type(ts.transpose(variable), ts.Variable)
assert_type(ts.concat([structural, structural]), VariableNode)
assert_type(ts.stack([structural, structural]), VariableNode)
...
assert_type(ts.maximum(structural, tensor), VariableNode)
assert_type(ts.maximum(tensor, structural), VariableNode)
assert_type(ts.minimum(structural, tensor), VariableNode)
assert_type(ts.minimum(tensor, structural), VariableNode)
assert_type(ts.clip(structural, 0.0, 1.0), VariableNode)
assert_type(ts.clip(variable, 0.0, 1.0), ts.Variable)
assert_type(ts.where(structural, tensor, tensor), VariableNode)
assert_type(ts.where(tensor, structural, tensor), VariableNode)
assert_type(ts.where(tensor, tensor, structural), VariableNode)
...
assert_type(ts.conv1d(structural, filters), VariableNode)
assert_type(ts.conv1d(signal, structural), VariableNode)
assert_type(ts.conv1d(signal, filters, structural), VariableNode)
...
assert_type(ts.conv2d(structural, window), VariableNode)
assert_type(ts.conv2d(image, structural), VariableNode)
...
assert_type(ts.conv3d(structural, volume_kernel), VariableNode)
assert_type(ts.conv3d(volume, structural), VariableNode)
