"""Strict selected-backend dispatch for logsumexp."""
...
def execute_logsumexp(
    ...
    *,
    ...
    """Run logsumexp on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute logsumexp conformingly. "
