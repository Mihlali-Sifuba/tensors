"""Strict selected-backend dispatch for reduce_norm."""
...
def execute_reduce_norm(
    ...
    *,
    ...
    """Run reduce_norm on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute reduce_norm conformingly. "
