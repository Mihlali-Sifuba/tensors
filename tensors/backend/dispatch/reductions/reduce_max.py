"""Strict selected-backend dispatch for reduce_max."""
...
def execute_reduce_max(
    ...
    *,
    ...
    """Run reduce_max on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute reduce_max conformingly. "
