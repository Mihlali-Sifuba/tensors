"""Strict selected-backend dispatch for reduce_std."""
...
def execute_reduce_std(
    ...
    *,
    ...
    """Run reduce_std on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute reduce_std conformingly. "
