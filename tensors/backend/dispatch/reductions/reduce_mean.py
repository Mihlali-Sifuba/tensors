"""Strict selected-backend dispatch for reduce_mean."""
...
def execute_reduce_mean(
    ...
    *,
    ...
    """Run reduce_mean on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute reduce_mean conformingly. "
