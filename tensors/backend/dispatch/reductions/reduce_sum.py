"""Strict selected-backend dispatch for reduce_sum."""
...
def execute_reduce_sum(
    ...
    *,
    ...
    """Run reduce_sum on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute reduce_sum conformingly. "
