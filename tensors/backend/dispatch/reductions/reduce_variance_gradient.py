"""Strict selected-backend dispatch for reduce_variance_gradient."""
...
def execute_reduce_variance_gradient(
    ...
    """Run reduce_variance_gradient on the selected backend without fallback."""
    ...
    result = backend.reduce_variance_gradient(
        grad_values,
        values,
        value.shape,
        axes,
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute reduce_variance_gradient conformingly. "
