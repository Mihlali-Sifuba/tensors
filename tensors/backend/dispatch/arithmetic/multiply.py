...
def execute_multiply(
    ...
    *,
    ...
    validate_operands((left, right), selected, context="multiply")
    if selected == "python":
        from tensors.backend.python.kernels.arithmetic.multiply import (
            multiply as reference,
        )
    ...
    return validate_result(result, selected, context="multiply")
