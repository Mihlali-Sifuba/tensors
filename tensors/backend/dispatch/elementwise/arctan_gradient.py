"""Strict dispatch for the arctan VJP."""
...
def execute_arctan_gradient(
    ...
    *,
    ...
    """Run the arctan VJP on the selected backend without fallback."""
    ...
    result = backend.arctan_gradient(
        lowered_grad,
        lowered_value,
        dtype=dtype,
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute arctan_gradient at dtype "
