"""Strict dispatch for the cosh VJP."""
...
def execute_cosh_gradient(
    ...
    *,
    ...
    """Run the cosh VJP on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute cosh_gradient at dtype "
