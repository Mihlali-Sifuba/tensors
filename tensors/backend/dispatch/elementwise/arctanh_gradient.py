"""Strict dispatch for the arctanh VJP."""
...
def execute_arctanh_gradient(
    ...
    *,
    ...
    """Run the arctanh VJP on the selected backend without fallback."""
    ...
    result = backend.arctanh_gradient(
        lowered_grad,
        lowered_value,
        dtype=dtype,
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute arctanh_gradient at dtype "
