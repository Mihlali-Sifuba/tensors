"""Strict dispatch for the tanh VJP."""
...
def execute_tanh_gradient(
    ...
    *,
    ...
    """Run the tanh VJP on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute tanh_gradient at dtype "
