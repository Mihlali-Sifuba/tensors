...
def execute_less(
    ...
    *,
    ...
    """Run less on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute less conformingly. "
            f"less runs on the selected backend; select another backend "
