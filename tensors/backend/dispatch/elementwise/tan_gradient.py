"""Strict dispatch for the tan VJP."""
...
def execute_tan_gradient(
    ...
    *,
    ...
    """Run the tan VJP on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute tan_gradient at dtype "
