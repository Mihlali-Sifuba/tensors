"""Strict dispatch for the sin VJP."""
...
def execute_sin_gradient(
    ...
    *,
    ...
    """Run the sin VJP on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute sin_gradient at dtype "
