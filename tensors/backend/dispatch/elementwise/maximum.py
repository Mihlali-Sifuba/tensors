...
def execute_maximum(
    ...
    *,
    ...
    """Run maximum on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute maximum at dtype "
            f"{dtype.name} conformingly. maximum runs on the selected backend; "
