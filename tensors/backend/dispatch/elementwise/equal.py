...
def execute_equal(
    ...
    *,
    ...
    """Run equal on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute equal conformingly. "
            f"equal runs on the selected backend; select another backend "
