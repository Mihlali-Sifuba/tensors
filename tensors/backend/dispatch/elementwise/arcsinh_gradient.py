"""Strict dispatch for the arcsinh VJP."""
...
def execute_arcsinh_gradient(
    ...
    *,
    ...
    """Run the arcsinh VJP on the selected backend without fallback."""
    ...
    result = backend.arcsinh_gradient(
        lowered_grad,
        lowered_value,
        dtype=dtype,
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute arcsinh_gradient at dtype "
