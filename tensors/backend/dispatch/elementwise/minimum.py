...
def execute_minimum(
    ...
    *,
    ...
    """Run minimum on the selected backend without fallback."""
    ...
    if result is None:
        raise BackendOperationUnsupportedError(
            f"The {selected} backend cannot execute minimum at dtype "
            f"{dtype.name} conformingly. minimum runs on the selected backend; "
