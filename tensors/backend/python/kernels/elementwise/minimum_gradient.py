"""Split minimum derivatives, sharing ties equally."""
...
def minimum_gradient(grad, left, right, *, needs_input_grad=(True, True)):
    """Route the upstream gradient to the smaller operand, sharing ties."""
