"""NumPy implementation of the power-exponent VJP (section 12.7)."""
...
def power_exponent_gradient(
    ...
    with _errstate(divide="ignore", over="ignore", under="ignore", invalid="ignore"):
        ...
        result = numpy.where(zero_base & (powers > 0.0), upstream * 0.0, result)
        ...
        result = numpy.where(bases < 0.0, upstream * nan, result)
