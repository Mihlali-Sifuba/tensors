"""NumPy implementation of the batched Adam parameter update."""
...
from tensors.backend.numpy.kernels.optim.batching import _optimizer_scalar_batch
...
def adam_updates(
    ...
    *,
    ...
    with _errstate(divide="ignore", over="ignore", under="ignore", invalid="ignore"):
        ...
        denominator = first * (root_moment + epsilon * root_correction)
