...
def _fused_operand_expression(step: FusedElementwiseStep, current: str) -> str | None:
...
def _fused_step_expression(
    step: FusedElementwiseStep, current: str
) -> tuple[str, str | None]:
...
def _fused_vjp_expressions(
    step: FusedElementwiseStep, value: str, result: str, upstream: str
) -> tuple[str, str | None]:
