"""CUDA implementation of not_equal."""
...
def not_equal(
    ...
    """Evaluate the broadcasting not_equal comparison on device arrays."""
    ...
    result = cupy.not_equal(left_values, right_values).astype(cupy.uint8, copy=False)
