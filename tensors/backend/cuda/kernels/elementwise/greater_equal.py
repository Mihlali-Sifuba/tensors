"""CUDA implementation of greater_equal."""
...
def greater_equal(
    ...
    """Evaluate the broadcasting greater_equal comparison on device arrays."""
    ...
    result = cupy.greater_equal(left_values, right_values).astype(
        cupy.uint8, copy=False
    )
