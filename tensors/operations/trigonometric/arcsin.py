"""Elementwise arcsin and its differentiation rule."""
...
class ArcSin(Operation):
    """Elementwise arcsin with a reverse-mode gradient rule."""
...
def arcsin(value: TensorLike | VariableNode) -> TensorResult | VariableNode:
    """Return the elementwise arcsin of a graph value or Tensor."""
